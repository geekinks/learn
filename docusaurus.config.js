...
const config = {
  title: 'GeekInk',
  tagline: 'A website for learning and sharing knowledge',
  favicon: 'img/favicon.ico',

  // Set the production url of your site here
  url: 'https://partners.geekink.live',
        ...
        links: [
          ...
          },
          {
            ...
            items: [
              {
                label: 'LinkedIn',
                href: 'https://www.linkedin.com/company/geeksink',
              },
              {
                label: 'Facebook',
